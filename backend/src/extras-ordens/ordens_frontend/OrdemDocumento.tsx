...
// Documento impresso ao emitir uma Ordem — réplica exata do modelo G10 Transportes.
// Usa window.print() do navegador (o usuário escolhe "Salvar como PDF" no diálogo de impressão).
